  ...
  <div class="flex justify-between mb-5">
    ...
    <div class="flex w-max gap-5">
      ...
      <m-button
        color="primary"
        class="w-64"
      >Добавить пост</m-button>
    </div>
  </div>

  <div class="rounded rounded-lg shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full p-5 mb-5">
      ...
      >
        ...
        >
          ...
          <td class="">
            ...
            <button class="rounded text-red-500 rounded-full border border-2 border-red-500 w-10 h-10">
...
watch(() => data.pagination.current_page, () => {
  console.log('12313')
})
</script>

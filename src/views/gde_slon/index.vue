        ...
        <div class="p-3">
          <div class="flex items-center gap-4">
            <button
              ...
              class="rounded-lg bg-green-100 text-green-600 transition-all duration-300 hover:bg-green-600 hover:text-green-200 dark:bg-cyan-500/20 dark:text-cyan-100"
              style="
                width: 55px;
                height: 55px;
                min-width: 55px;
        ...
        <div class="p-3">
          <div class="flex items-center gap-4">
            <button
              ...
              class="rounded-lg bg-red-100 text-red-600 transition-all duration-300 hover:bg-red-600 hover:text-red-200 dark:bg-cyan-500/20 dark:text-cyan-100"
              style="
                width: 55px;
                height: 55px;
                min-width: 55px;

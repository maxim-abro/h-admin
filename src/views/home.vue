<template>
  ...
  <div class="grid grid-cols-2 gap-5">
    <div class="grid grid-cols-3 gap-5 w-full mb-5">
      <div class="flex h-48 gap-5 rounded rounded-lg flex-col items-center justify-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full">
        <font-awesome-icon icon="ticket" class="text-primary text-3xl"/>
        <div class="text-sm">Опубликовано купонов</div>
        <div class="text-primary text-xl">{{ data.postCounter }}</div>
      </div>
      <div class="flex h-48 rounded rounded-lg flex-col items-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full">
        <div class="flex h-48 gap-5 rounded rounded-lg flex-col items-center justify-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full">
          <font-awesome-icon icon="shopping-cart" class="text-primary text-3xl"/>
          <div class="text-sm">Опубликовано магазинов</div>
      ...
      <div class="flex h-48 rounded rounded-lg flex-col items-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full">
        <div class="flex h-48 gap-5 rounded rounded-lg flex-col items-center justify-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full">
          ...
          <div class="text-sm">Всего категорий</div>
          <div class="text-primary text-xl">{{ data.categoryCounter }}</div>
        </div>
      </div>
    </div>
    <div class="grid grid-cols-4 gap-5">
      <div class="flex h-48 rounded rounded-lg flex-col items-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full"></div>
      <div class="flex h-48 rounded rounded-lg flex-col items-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full"></div>
      <div class="flex h-48 rounded rounded-lg flex-col items-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full"></div>
      <div class="flex h-48 rounded rounded-lg flex-col items-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full"></div>
    </div>
  ...
  <div class="grid grid-cols-2 gap-5 mb-5">
    <div class="flex rounded rounded-lg flex-col items-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full">

    </div>
    <div class="p-5 rounded rounded-lg flex-col items-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full">
      <h2 class="text-second font-medium text-xl">Популярные купоны</h2>
      <table class="table table-list mt-3 w-full mb-5" v-if="data.popularPosts.length">
        <thead>
          <tr class="text-primary-700">
            <th class="ltr:text-left rtl:text-right uppercase text-second">Название</th>
            <th class="w-px">Просмотров</th>
            <th class="w-px">Рейтинг</th>
          </tr>
        </thead>
        <tbody>
        <tr v-for="post of data.popularPosts" :key="post.title" class="border-y border-y-2 h-10">
  ...
  <div class="grid grid-cols-2 gap-5">
    <div class="rounded rounded-lg flex-col items-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full">
<!--      <m-bar-chart-->
...
<!--      />-->
    ...
    <div class="rounded rounded-lg flex-col items-center shadow-[0_0_4px_1px_rgba(0,0,0,0.1)] bg-white w-full p-5">
